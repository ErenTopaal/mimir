  ...
  return (
    <section
      ...
      className={cn(
        ...
        "[&_.annotation-badge]:align-middle [&_.annotation-badge]:-translate-y-px [&_.annotation-badge]:cursor-pointer",
        "[&_.annotation-badge]:hover:scale-105 [&_.annotation-badge]:hover:opacity-90 [&_.annotation-badge]:transition-transform",
