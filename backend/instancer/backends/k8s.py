...
class Labels(StrEnum):
    ...
    JOB_ID = 'avaxbench.osec.io/job-id'
...
class K8sBackend(BackendABC):
    def __init__(self, args: dict[str, str]) -> None:
        ...
        self.managed_by_value = args.get('managed_by', 'avaxbench')
    ...
    async def start_worker(self, options: StartWorkerOptions) -> StartWorkerResult:
        ...
        namespace_name = f'avaxbench-job-{options.job_id}'
        while True:
            try:
            ...
            client.V1NetworkPolicy(
                ...
                spec=client.V1NetworkPolicySpec(
                    ...
                    egress=[
                        ...
                        # allow egress to avaxbench:secretsvc (for prod)
                        client.V1NetworkPolicyEgressRule(
                            to=[
                                client.V1NetworkPolicyPeer(
                                    pod_selector=client.V1LabelSelector(
                                    ...
                                    namespace_selector=client.V1LabelSelector(
                                        match_labels={
                                            'kubernetes.io/metadata.name': 'avaxbench',
                                        },
                                    ),
                                ),
                            ],
                        ...
                        # allow egress to avaxbench:resultsvc (for prod)
                        client.V1NetworkPolicyEgressRule(
                            to=[
                                client.V1NetworkPolicyPeer(
                                    pod_selector=client.V1LabelSelector(
                        ...
                        # allow egress to avaxbench:oai_proxy
                        client.V1NetworkPolicyEgressRule(
                            to=[
                                client.V1NetworkPolicyPeer(
                                    pod_selector=client.V1LabelSelector(
